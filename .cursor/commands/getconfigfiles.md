...
**Step 1 - Dump config from infobase:**

```bash
/opt/1cv8/x86_64/8.3.27.1859/1cv8 DESIGNER /F '<INFOBASE_PATH>' /N'<USERNAME>' /DisableStartupMessages /DumpConfigToFiles <PROJECT_ROOT> -listFile repoobjects.txt -Extension OneAPA /Out /tmp/1c_update.log
```
